...
for index, list in CONSTANT.items():
    for str in list:
...
class Rectangle(object):
    ...
    @property
    def x(self):
        return (self.upper_left.x + self.lower_right.x) // 2

    @property
    def y(self):
        return (self.upper_left.y + self.lower_right.y) // 2

    @property
    def z(self):
        return (self.upper_left.z + self.lower_right.z) // 2
