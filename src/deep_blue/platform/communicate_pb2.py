...
_sym_db.RegisterMessage(Element.Size)
...
StableInfo = _reflection.GeneratedProtocolMessageType('StableInfo', (_message.Message,), dict(
  DESCRIPTOR = _STABLEINFO,
  __module__ = 'communicate_pb2'
  # @@protoc_insertion_point(class_scope:teamstyle16.communicate.StableInfo)
  ))
_sym_db.RegisterMessage(StableInfo)

RoundInfo = _reflection.GeneratedProtocolMessageType('RoundInfo', (_message.Message,), dict(

  ProductionEntry = _reflection.GeneratedProtocolMessageType('ProductionEntry', (_message.Message,), dict(
...
_sym_db.RegisterMessage(RoundInfo.ProductionEntry)
