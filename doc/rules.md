...
* 可以设置补给量，或尽力补给。（警告：运输舰、航母需要保留一些燃料供自己使用，否则会导致抛锚）
 （这个不用选手操心，补给时会有限定）（@逻辑：如何限定？）
...
### 初始条件
双方所有单位（包括基地）资源充满，满血。据点满血无主。

### 胜利条件
摧毁对方基地，或回合达到回合数上限时积分较高者获胜

### 视野范围
地形全可见（海洋、基地、据点、油田、矿场），每个单位均有三层视野范围，己方单位共享视野范围
