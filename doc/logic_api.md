...
|        构造函数        |              描述             |
| ---------------------- | ----------------------------- |
| Command(game, operand) | 指令, operand为操作对象索引号 |

### Class AttackPos
|            构造函数           |   描述   |
| ----------------------------- | -------- |
| AttackPos(game, operand, pos) | 攻击坐标 |

### Class AttackUnit
|              构造函数             |   描述   |
| --------------------------------- | -------- |
| AttackUnit(game, operand, target) | 攻击单位 |


### Class ChangeDest
|             构造函数            |    描述    |
| ------------------------------- | ---------- |
| ChangeDest(game, operand, dest) | 更改目的地 |

### Class Fix
|          构造函数          | 描述 |
| -------------------------- | ---- |
| Fix(game, operand, target) | 维修 |

### Class Produce
|           构造函数           | 描述 |
| ---------------------------- | ---- |
| Produce(game, operand, kind) | 生产 |

### Class Supply
|                          构造函数                         |          描述          |
| --------------------------------------------------------- | ---------------------- |
| Supply(game, operand, target, fuel=-1, metal=-1, ammo=-1) | 补给, 量为负则尽力补给 |
